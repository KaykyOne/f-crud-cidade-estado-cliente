...
namespace CrudEstadoCidadeUsuario.Controllers
{
    public class EstadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstado,Nome,Sigla")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstado,Nome,Sigla")] Estado estado)
        {
